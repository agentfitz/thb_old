...
/*-----------------------------------------------------------------------------------*/
        ...
        <?php /* <div class="comments-sidebar">
            ...
            <a href="#respond"><span class="continue-reading "><?php comment_form_title( __('Leave a Comment', 'framework'), __('Leave a Reply to %s', 'framework') ); ?></span></a></p>
